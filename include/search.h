...
void test_two_phase_nn(Matrix<float> &queries, int K, Matrix<float> &points, std::vector<std::vector<int>> &GT, AdjList &graph, std::vector<Guided_tree *> &trees, int max_calc, int start, int L);
void test_vote(Matrix<float> &queries, int K, Matrix<float> &points, std::vector<std::vector<int>> &GT, AdjList &graph, std::vector<std::vector<Guided_tree *>> &forest, int max_calc, int start, int L);
